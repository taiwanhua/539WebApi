...
namespace TL539WebApi.DbContexts
{
	public class TL539WebApiContext : DbContext
	{
		public TL539WebApiContext(DbContextOptions<TL539WebApiContext> options) : base(options)
		{
		}

		
		public DbSet<WinNumber> WinNumbers { get; set; }
